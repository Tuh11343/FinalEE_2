                ...
                <ul class="header__navbar-sitemenu">
                    ...
                    <li class="item">
                        ...
                        <ul class="dropmenu sortmenu">
                            <c:forEach items="${requestScope.itemTypeList}" var="itemType" varStatus="status">
                                <li>
        ...
        <div class="header__right">
            ...
            <c:if test="${not empty cookie.signInAccountID}">
                ...
                <div class="header__right--icon user-login btn-dropdown">
                    <a href="#" class="btn-dropdown" style="display: flex; align-items: center;gap: 5px;">${requestScope.accountList[accountIndex].customer.name}
                    ...
                    <div class="user-dropdown">
                        ...
                        <form id="form_account" action="${pageContext.request.contextPath}/HeaderServlet" method="post">
                        ...
                        <form id="form_order" action="${pageContext.request.contextPath}/HeaderServlet" method="post">
                        ...
                        <form id="form_signOut" action="${pageContext.request.contextPath}/HeaderServlet" method="post">
