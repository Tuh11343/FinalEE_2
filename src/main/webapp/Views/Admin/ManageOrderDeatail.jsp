        ...
        <div class="orderdetail-data table-data active" data-type="orderDetailList">
          ...
          <div id="update-orderDetail" class="modal-update flex-center">
            <div class="update-modal">
              ...
              <form
                action="${pageContext.request.contextPath}/ManageOrderDetailtServlet"
                method="post"
              >
                <!--Order Detail ID-->
                <div class="form-grp">
                ...
                <div class="flex-center">
                  <a id="updateOrderDetail" class="btn submit">Cập nhật</a>
                </div>
          ...
          <div id="add-orderDetail" class="modal-add flex-center modal__addOrderDetail">
            <div class="add-modal">
              ...
              >
                ...
                <div class="flex-center">
                  <a id="addOrderDetail" class="btn submit"> Thêm </a>
                </div>
