            ...
            <div class="header-table">
                ...
                <div class="AddItemType listbtn">
                    ...
                    <form>
                        <button
                                class="btnHD btnload"
                                style="margin-left: 5px; margin-bottom: 4px" onclick="refreshItemType()"
                        >
                            Refresh
                        </button>
                ...
                <form
                        ...
                        method="post" onsubmit="return searchAndSortItemType()"
                >
                    <div class="sorttable">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex-center grpbtn">
                                    ...
                                    <button class="btnHD btnDel" type="submit" onclick="deleteItemType(${itemType.id})">
                                        Xóa
                                    </button>
                ...
                <div class="update-modal">
                    ...
                    <form>
                        ...
                        <div class="flex-center">
                            <a id="updateItemType" class="btnHD btnAdd submit" onclick="updateItemType()">Cập nhật</a>
                        </div>
            ...
            <div id="add-itemType" class="modal-add flex-center modal__addItemType">
                <div class="add-modal">
                    ...
                    <form>
                        ...
                        <div class="flex-center">
                            <a id="addItemType" type="submit" class="btnHD btnAdd submit"
                               onclick="addItemType()">Thêm</a>
                        </div>
