    ...
    <div class="container">
        <div class="header__left">
            <div class="header__logo">
                <a href="#"><img class="img" src="assets/logo (1).png" alt="img-logo" /></a>
            </div>
        ...
        <div class="container">
            <div class="productItem">
                ...
                >Giày Tây Lười Da Phụ Kiện Nguyên Bản A4 2022
                    ...
                    <p class="productID" style="font-size: 15px; margin-bottom: 1rem">
                        Mã số: #0021024
                    </p>
                    <h5
                            class="sale"
                            style="line-height: 32px; font-size: 1.25rem; margin: 0px">
                        <img
                    ...
                    <h6 class="price" style="font-size: 1rem; margin-bottom: 0.5rem">
                        Giá gốc:
                        <span
                                style="
                    ...
                    <p class="textAmount" style="margin-bottom: 0.25rem">
                        số lượng có hạn
                    </p>
                    <div class="amount">
                    ...
                    <table class="productVariants">
                        ...
                        <tr>
                            ...
                            <td style="text-align: right">
                                Sale <b>557,900</b>đ
                                <i class="fa fa-plus-circle" > <a href="">Chọn mua</a></i>
                            </td>
                        </tr>
                        <tr>
                            <td>Đen, 41</td>
                            ...
                            <td style="text-align: right">
                                Sale <b>557,900</b>đ <i class="fa fa-plus-circle" > <a href="">Chọn mua</a></i>
                            </td>
                        </tr>
                        <tr>
                            <td>Đen, 42</td>
                    ...
                    <div class="tutorials">
                        ...
                        <button>Xem mô tả sản phẩm</button>
                    </div>
                </div>
            </div>
