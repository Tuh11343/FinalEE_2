            ...
            <div class="revenue cardtstatic col-md-4">
              ...
              >
                ...
                <div class="bestsaling__list">
                  ...
                  >${statistic[0]}</span
                  >
                            <span class="col-md-3">${statistic[1]}</span>
                        </div>
                    </c:forEach>
                </div>
            </div>
        ...
        <div class="row gap-5 ">
            ...
            <div class="prodcutbyquantity cardtstatic col-md-7">
                <div class="prodcutbyquantity__header row   ">
                    <span class=" col-md-3 text-center">Tên sản phẩm</span>
                    <span class=" col-md-9  text-center">Số lượng</span>
                </div>
                <div class="prodcutbyquantity__list row">
                    <c:forEach items="${requestScope.recentFiveMonthRevenue}" var="statistic">
                        <span class=" col-md-3 ">${statistic[0]}</span>
                        <span class=" col-md-9  text-center">${statistic[1]}</span>
                    </c:forEach>
                </div>
            </div>
        </div>
