...
function updateOrderStatus() {
    ...
    console.log(update_orderStatusID);
...
function orderStatusToExcel() {
    let table = document.getElementById("tableOrderStatus");
    ...
    XLSX.utils.book_append_sheet(workbook, sheet, "OrderStatus");

    XLSX.writeFile(workbook, "orderStatus.xlsx");
}