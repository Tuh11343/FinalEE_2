...
<!--            //Nút đăng nhập-->
<!--            //không đăng nhập hiện ra cái này-->
...
<!--//có đăng nhập rồi hiện ra cái này. hướng cách làm cảu t là check cokie trên máy, có userAcc thì hiẹn ra còn không để chữ đăng nhập-->
            <div class="header__right--icon user-login btn-dropdown">
                <a href="#" class="btn-dropdown" style="display: flex; align-items: center;gap: 5px;">Thanh Tuấn
                ...
                <div class="user-dropdown">
                    <a class="dropmenu--item">Tài khoản
                    ...
                    <a class="dropmenu--item">Đơn hàng
                    ...
                    <a class="dropmenu--item">Đăng xuất
