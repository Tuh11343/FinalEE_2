...
function addStockItem() {
    ...
    if (add_stockItemItemID == null || add_stockItemItemID == "" || add_stockItemSize == null || add_stockItemSize == ""
        ...
        var num = parseFloat(add_stockItemAmount);
        if (Number.isInteger(num)) {
            $.ajax({
                ...
                data: {
                    action: "addStockItem",
                    add_stockItemItemID: add_stockItemItemID,
            ...
            alert("Kiểu dữ liệu điền vào không hợp lệ");
        }
    }
}
...
function updateStockItem() {
    ...
    if (update_stockItemItemID == null || update_stockItemItemID == "" || update_stockItemSize == null || update_stockItemSize == ""
        ...
        var num = parseFloat(update_stockItemAmount);
        if (Number.isInteger(num)) {
            $.ajax({
                type: "POST",
                url: adminManagerContextPath + "/ManageStockItemServlet",
                data: {
                    ...
                    update_stockItemItemID: update_stockItemItemID,
...
function searchAndSortStockItem() {
    ...
    if (stockItemSearchType == "id" || stockItemSearchType == "itemID") {
