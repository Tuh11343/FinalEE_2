                                    ...
                                    <ul class="dropmenu">
                                        <c:forEach items="${itemCollectionList}" var="itemCollection">
                                            <li>
                                                ...
                                                <a
                                                    onclick="itemCollectionClick(`form_itemCollection`)">${itemCollection.name}</a>
                                                <form id="form_itemCollection" action="/ItemServlet" method="post">
                                                    <input type="hidden" value="${itemCollection.name}"
                                                        name="itemType" />
                        ...
                        <div class="scproduct__list listproduct">
                            ...
                            <div class="scproduct__list--item product">
                                ...
                                <div class="productInfo">
                                    ...
                                    <p class="desc">Vải cotton hay còn gọi là cotton 100%, được làm từ sợi bông thiên
