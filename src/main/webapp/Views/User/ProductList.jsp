                ...
                <body class="productpage">
                                    ...
                                    <div class="scproduct__top--sort">
                                        ...
                                        <form action="${pageContext.request.contextPath}/ItemSearchServlet" method="get"
                                            ...
                                            <div class="sort-item rangeprice">
                                                ...
                                                <div class="rangnumber">
                                                    <span class="pricefirst">10000</span>
                                                    <span class="priceend">30000</span>
                                                </div>
                                            </div>

                                            <div class="sort-item">
                                                <input type="hidden" value="${requestScope.currentPage}"
                                                    name="currentPage">
                    ...
                    <script>
                        ...
                        priceSlider.noUiSlider.on('update', function (values, handle) {
                            ...
                            let priceone = Number(values[0]).toLocaleString('en-US', { style: 'decimal' }),
                                pricetwo = Number(values[1]).toLocaleString('en-US', { style: 'decimal' });
                            //lay gai tri tien o day
                            //hienthi tien len UI
                            document.querySelector('.rangnumber .pricefirst').innerHTML = priceone + ' VND';
                            document.querySelector('.rangnumber .priceend').innerHTML = pricetwo + ' VND';
                            //gan gia tri tien len the input an
                    ...
                    <script src="${pageContext.request.contextPath}/Views/User/dest/wNumb.min.js"></script>
