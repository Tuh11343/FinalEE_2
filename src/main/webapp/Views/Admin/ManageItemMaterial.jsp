                  ...
                  <td>
                    <div class="flex-center grpbtn">
                      ...
                      <form action="${pageContext.request.contextPath}/ManageItemMaterialServlet" method="post"
                        ...
                        <input type="hidden" value="${itemMaterial.id}" name="itemMaterialID">
                        <input type="hidden" value="deleteItemMaterial" name="action">
                      </form>
            ...
            <div class="update-modal">
              ...
              >
                ...
                <div class="flex-center">
                  <a id="updateItemMaterial" class="btnHD btnAdd submit">Cập nhật</a>
                </div>
          ...
          <div id="add-itemMaterial" class="modal-add flex-center modal__addItemMaterial">
            <div class="add-modal">
              ...
              >
                ...
                <div class="flex-center">
                  <button id="addItemMaterial" class="btnHD btnAdd submit"> Thêm </button>
                </div>
