        ...
        <div class="product-data table-data active" data-type="orderStatusList">
            <div class="header-table">
                ...
                <form
                        ...
                        method="post" onsubmit="return searchAndSortOrderStatus()"
                >
                    <div class="sorttable">
                            ...
                            <td>
                                <div class="flex-center grpbtn">
                                    ...
                                    <button class="btnHD btnDel" type="submit"
                                            onclick="deleteOrderStatus(${orderStatus.id})">Xóa
                                    </button>
            ...
            <div id="add-orderStatus" class="modal-add flex-center modal__addOrderStatus">
                <div class="add-modal">
                    ...
                    <h2 class="text-center" style="padding: 16px 0">Thêm Tình Trạng Đơn Hàng</h2>
                    <form>
                        <!--Order Status Name-->
                        <div class="form-grp">
                            ...
                            <input
                                    ...
                                    value=""
                                    placeholder="Nhập vào tên tình trạng"
                            />
                        </div>
