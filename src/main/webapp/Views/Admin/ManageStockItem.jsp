                ...
                <tr>
                  ...
                  <td>
                    <div class="flex-center grpbtn">
                      ...
                      <form action="${pageContext.request.contextPath}/ManageStockItemServlet" method="post"
                            onsubmit="return confirmDelete()">
                        <button class="btnHD btnDel" type="submit">Xóa</button>
                        <input type="hidden" value="${stockItem.id}" name="stockItemID">
                        <input type="hidden" value="deleteStockItem" name="action">
                      </form>
            ...
            <div class="update-modal">
              ...
              >
                ...
                <div class="flex-center">
                  <a id="updateStockItem" class="btn submit">Cập nhật</a>
                </div>
          ...
          <div id="add-stockItem" class="modal-add flex-center modal__addStockItem">
            <div class="add-modal">
              ...
              >
                ...
                <div class="flex-center">
                  <button id="addStockItem" class="btn submit">Thêm</button>
                </div>
