      ...
      <div class="center">
        ...
        <div class="permission-data table-data active" data-type="permissionList">
          <div class="header-table">
            ...
            <form
              action="${pageContext.request.contextPath}/ManagePermmissionServlet"
              method="post"
            >
              <div class="sorttable">
            ...
            <div class="update-modal">
              ...
              >
                ...
                <div class="flex-center">
                  <a id="updatePermission" class="btn submit">Cập nhật</a>
                </div>
          ...
          <div id="add-permission" class="modal-add flex-center modal__addPermission">
            <div class="add-modal">
              ...
              >
                ...
                <div class="flex-center">
                  <a id="addPermission" class="btn submit"> Thêm </a>
                </div>
