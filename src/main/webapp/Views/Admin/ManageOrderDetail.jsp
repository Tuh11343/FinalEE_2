                ...
                <tr>
                  ...
                  <td>
                    <div class="flex-center grpbtn">
                      ...
                      <form action="${pageContext.request.contextPath}/ManageOrderDetailServlet" method="post"
                            onsubmit="return confirmDelete()">
                        <button class="btnHD btnDel" type="submit">Xóa</button>
                        <input type="hidden" value="${orderDetail.id}" name="orderDetailID">
                        <input type="hidden" value="deleteOrderDetail" name="action">
                      </form>
            ...
            <div class="update-modal">
              ...
              >
                ...
                <div class="flex-center">
                  <button id="updateOrderDetail" class="btnHD btnAdd submit">Cập nhật</button>
                </div>
          ...
          <div id="add-orderDetail" class="modal-add flex-center modal__addOrderDetail">
            <div class="add-modal">
              ...
              >
                ...
                <div class="flex-center">
                  <button id="addOrderDetail" class="btnHD btnAdd submit"> Thêm </button>
                </div>
